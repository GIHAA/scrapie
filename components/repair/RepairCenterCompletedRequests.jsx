...
import RepairRequestedCompletedCard from "./RepairRequestCompletedCard";
...
const RepairCenterCompletedRequests = () => {
    return (
        <ScrollView>
            {completedRequests.map((request, index) => (
                <RepairRequestedCompletedCard
                    key={index}
                    ...
                    deliveredAt={request.deliveryAt}
                />
            ))}
        </ScrollView>
    );
...
export default RepairCenterCompletedRequests;
